...
<v-img src="../assets/Sun-Tornado.svg" gradient="to top right, rgba(20,20,20,.2), rgba(25,32,72,.35)" class="bkg-img">
    <div>
        <v-data-table v-model="selected" show-select :headers="headers" :expanded.sync="expanded" show-expand :items="egresos" :search="search" item-key="_id" sort-by="Name" class="elevation-1">
...
export default {
    ...
    methods: {
        ...
        getegresos() {
            axios.get(urlAPI + 'egreso')
                .then(res => {
                    this.egresos = res.data.egreso.filter(egreso => aClient.Status === "ACTIVE")
                });
        },
        ...
        deleteItemConfirm() {
            ...
            for (let i = 0; i < this.selected.length; i++) {
                ...
                this.egresos.splice(this.egresos.indexOf(this.selected[i]), 1);
            }
        },
        ...
        save(id) {
            ...
            //Editar Cliente
                ...
                if (this.validate()) {
                    Object.assign(this.egresos[this.editedIndex], this.client)
