                ...
                <v-container>
                    <ol>
                        <li v-for="(elemento,index) in Factura.Elements" :key="index">
                            ...
                            <v-text-field readonly :value="'Precio: 
...
export default {
    ...
    methods: {
        ...
        getRepuestos() {
            axios.get(urlAPI + "product").then(res => {
                if (res != null) {
 ...
 getRepuestos() {
        ...
        calcularTotal() {
            if (this.reserva != null) {
                    ...
                    this.reserva.Service.forEach(r=>{
                        r.Product.forEach(p=>{
                            let product = this.products.find(pr=> pr._id== p);
                            if(product!=null){
...
+elemento.PrecioConDescuento"></v-text-field>
                            </div>

                            <div v-if="Factura.Kind=='A'">
                                <v-text-field readonly :value="'Impuestos: 
